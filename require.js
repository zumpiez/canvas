(function () {
    ...
    // a variable that will store the loaded files, and DOM position
    var loaded = null, lastScript;

    // if a require function is not defined
    if (typeof window.require === "undefined") {
        // create a map for the loaded scripts
        loaded = {};
        // create the require function
        window.require = function (requirement, callback) {
